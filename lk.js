...
window._graphics = new gezira.Renderer(sdl.videoSurface.pixels,
                                       sdl.videoSurface.width,
                                       sdl.videoSurface.height,
                                       sdl.videoSurface.pitch,
                                       sdl.videoSurface.bytesPerPixel);
window.document._graphics =
  (new gezira.TranslationNode(0, sdl.videoSurface.height)).children(
    (new gezira.ScaleNode(1, -1)).children(
      (new gezira.ColorBackgroundNode(0.5, 0.7, 0.8)).children(
        dom.graphics.render(window.document.documentElement))));
window.refresh();
